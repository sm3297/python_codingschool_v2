  ...
  },
  {
    ...
    missions: [
      ...
      },
      {
        ...
        code: '# 한 줄에 세 변수의 값을 할당하세요!\nname, age, is_student = ???, ???, ???\n\nprint("이름:", name)\nprint("나이:", age)\nprint("학생인가요?", is_student)\n\n# 같은 값을 여러 변수에 동시에 할당하세요!\nx = ??? = ??? = 100\nprint("x, y, z의 값은 모두", x, "입니다!")',
        explanation: [
  ...
  },
  {
    ...
    missions: [
      ...
      },
      {
        ...
        code: 'hp_count = 5\nmp_count = 3\n\n# 문자열 곱셈을 이용해 하트와 물방울을 개수만큼 만드세요!\nhp_bar = "❤️" * ???\nmp_bar = "💧" * ???\n\nprint("==================")\nprint("용사 상태창")\nprint("------------------")\nprint("체력(HP) : " + hp_bar)\nprint("마력(MP) : " + mp_bar)\nprint("==================")',
        explanation: [
  ...
  },
  {
    ...
    missions: [
      ...
      },
      {
        ...
        code: 'print("--- 폭탄 해체 시퀀스 시작 ---")\n\n# input()을 사용해 사용자에게 질문하고 변수에 저장하세요!\npassword = ???("해체 비밀번호를 입력하세요: ")\ncolor = ???("어떤 색의 선을 자를까요? (빨강/파랑): ")\ntimer = ???("타이머를 몇 초 남기고 멈출까요?: ")\n\nprint("입력 확인: 비밀번호는", password, ", 자를 선은", color, ",", timer, "초에 정지합니다.")',
        explanation: [
